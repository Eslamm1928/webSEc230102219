...
Route::get('/users/create-customer', [UsersController::class, 'showCreateEmployee'])->name('users.create_Employee');
Route::post('/users/create-customer', [UsersController::class, 'createEmployee']);
